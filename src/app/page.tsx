...
const PERKS = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description:
      'Every asset on our platform iis verified by team to ensure our highest quality standards. Not happy? W offer a 30-day Guarantee.',
  },
  {
    name: 'For the Planet',
    Icon: Leaf,
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tighter text-gray-950">
            Your marketplace for hig-quality{' '}
