...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        ...
        var user, productIds, payload, products, filteredProducts, order, line_items, _i, filteredProducts_1, product, stripeSession, err_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    order = _c.sent();
                    line_items = [];
                    for (_i = 0, filteredProducts_1 = filteredProducts; _i < filteredProducts_1.length; _i++) {
                        product = filteredProducts_1[_i];
                        if (product.priceId) {
                            line_items.push({
                ...
                case 6:
                    err_1 = _c.sent();
                    console.error('Erro ao criar sessão do Stripe:', err_1);
